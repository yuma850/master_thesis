...
\begin{titlepage}
  \begin{center}
    ...
    {\Large 修士学位論文}\\
		\vspace{65mm}
    {\huge 鋼橋の塗膜剥離支援を行う\\\vspace{2mm}磁気クローラ式壁面移動ロボットの開発}
    \vspace{3mm}
    {\Large Development of Wall Locomotion Robot with Magnetic Crawlers to Support Paint Removal of Steel Bridges}\\
    \vspace{65mm}
		{\Large 2023年3月}\\
    \vspace{10mm}
    {\Large 所属：未来ロボティクス専攻}\\
