...
\section {日本の鋼橋と塗膜剥離工法}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.9\textwidth]{IHkouhougaiyou.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\textwidth]{ih-work.png}
...
\section{現場環境とこれまでの取り組み}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1.0\textwidth]{bridge_types.png}
...
\newpage
	\subsection{先行研究}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.4\textwidth]{mecanamu.png}
...
\newpage
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.5\textwidth]{zikicrowler.png}
  		\caption{Wall Surface Robot with Magnetic Crawlers\cite{magnetic-clawlar3}}
			\label{fig:ih5}
		\end{figure}
